...
public class Database {
    ...
    public Database() {
        ...
        medicineList.add(new Medicine(4L, "Paracetamol", "2.5 ml", "Pharma", Category.ANTIBIOTICS, 5500.0, 0.0));
        medicineList.add(new Medicine(1L, "Vitamin B", "2.5ml", "France", Category.VITAMINS, 1000.0, 0.0));
        medicineList.add(new Medicine(5L, "Valeriana", "2.5 ml", "EGIS Pharmaceuticals", Category.SEDATIVE, 1200.0, 0.0));
        medicineList.add(new Medicine(6L, "Vitamin C", "1 ml", "EGIS Pharmaceuticals", Category.VITAMINS, 6000.0, 0.0));
        medicineList.add(new Medicine(1L, "Vitamin B", "2.5ml", "France", Category.VITAMINS, 1000.0, 0.0));
